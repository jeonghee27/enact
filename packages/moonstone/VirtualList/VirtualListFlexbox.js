...
import VirtualListBaseFlexbox, {gridListItemSizeShape} from './VirtualListBaseFlexbox';
 ...
 * @public
 */
const VirtualListFlexbox = kind({
	name: 'VirtualListFlexbox',
	...
	render: (props) => <VirtualListBaseFlexbox {...props} />
});
 ...
 * @public
 */
const VirtualGridListFlexbox = kind({
	name: 'VirtualGridListFlexbox',
	...
	render: (props) => <VirtualListBaseFlexbox {...props} pageScroll />
});

export default VirtualListFlexbox;
export {VirtualListFlexbox, VirtualGridListFlexbox};
